...
int main() {
 ...
 //     
	...
	//Varaible projecton = matriz 4x4 llena de 1's
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Dibujar un cubo a cada lado, traslaciones diferentes, rotaciones diferentes y escalados diferentes
		...
		model = glm::rotate(model, 0.5f, glm::vec3(0.0f, 0.0f, 2.0f)); // use to compare orthographic and perspective projection
